...
NSString * const CalcDebuggerDidPauseNotification =
    @"CalcDebuggerDidPauseNotification";
...
{
    [self willChangeValueForKey:@"disassembly"];
    [self didChangeValueForKey:@"disassembly"];
}
...
- (void)notifyPausedWithBreakType:(NSNumber *)aBreakType
{
    ...
    [[NSNotificationCenter defaultCenter]
        postNotificationName:CalcDebuggerDidPauseNotification
                      object:self];
}
